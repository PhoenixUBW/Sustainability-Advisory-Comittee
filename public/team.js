...
const israel = new TeamMember("Israel","I'm Israel, one of the three individuals who helped work on this project. I am the lead director behind the function of the homepage, and my primary job was the html and css behind the homepage. I also had the task of using the information and tools at my disposal to create a vivid and user-friendly colour scheme for my teammates to work off of when designing their pages. My passion is to push the boundaries of the knowledge that I have in computer science to new heights through perseverence and tenacity, which led me to taking part in this project. I hope that you will be able to see the hard work, dedication and love put into this website as you look through it. Thank you for reading about me and my participation in this project!","outlier")
